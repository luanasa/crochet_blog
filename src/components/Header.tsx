      ...
      <div className="mt-36 p-6 ml-56 flex justify-between mr-60">
        <div>
          ...
          <button 
            ...
            className="rounded-2xl bg-slate-50 px-3.5 py-2.5 text-lg font-semibold text-black shadow-sm hover:bg-slate-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 mt-10 w-36 h-12"
          >
            receitas
          </button>
        </div>
        ...
        <div>
          <img className="" src="./hero_ghost.png" alt="Hero" />
        </div>
      </div>
    </div>
  );
